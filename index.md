...
- `concepts/loop-verification-gate.md` — 결정적 선통과+격리 반박자를 루프 완료 게이트로 두는 검증 방법론
...
- `concepts/vllm-serving-operations.md` — vLLM 서버 운영: 기동 로그 다섯 단계와 메모리 예산 나눗셈·설정값 넷의 상충·운영 통계 줄과 지표로 병목 가르기·기동 실패 유형
